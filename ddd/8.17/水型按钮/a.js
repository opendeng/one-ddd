var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var LiquidButton = function () {
    function LiquidButton(optionsParam) {_classCallCheck(this, LiquidButton);
      ...
      this.initOrigins();
      this.animate();
    }_createClass(LiquidButton, [{ key: 'distance', value: function distance(
      ...
      } }, { key: 'drawDebug', value: function drawDebug()
      ...
      } }, { key: 'createPoint', value: function createPoint(
      ...
      } }, { key: 'initOrigins', value: function initOrigins()
  
      {
        ...
        for (var layerIndex = 0; layerIndex < this.layers.length; layerIndex++) {
          ...
          for (var _alpha = 0; _alpha <= ~~(this.height * 1.25); _alpha += this.gap) {
            ...
            points.push(this.createPoint(
            this.height - Math.sin(_angle) * this.height / 2 + this.margin - this.height / 2,
            Math.cos(_angle) * this.height / 2 + this.margin + this.height / 2));
  
          }
          layer.points = points;
        }
      } }, { key: 'mousemove', get: function get() {var _this2 = this;return function (e) {_this2.touches = [{ x: e.offsetX, y: e.offsetY, z: 0, force: 1 }];};} }, { key: 'mouseout', get: function get() {var _this3 = this;return function (e) {_this3.touches = [];};} }, { key: 'raf', get: function get() {return this.__raf || (this.__raf = (window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function (callback) {setTimeout(callback, 10);}).bind(window));} }]);return LiquidButton;}();
